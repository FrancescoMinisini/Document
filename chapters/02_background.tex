...
\textbf{TODO:} footnote sulla norma di haar
...
% \textbf{TODO:} Write the complete derivation of this expression
...
% \textbf{TODO:} Deciding if I want to keep this stuff in, since crab and krotov are not the main focus of my thesis
...
\textbf{TODO:} replace with snippet
\begin{figure}[t]
\centering
\begin{tikzpicture}[
    box/.style={draw, rounded corners, minimum width=3.0cm, minimum height=1.0cm, align=center},
