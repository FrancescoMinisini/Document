...
% Intended drive
\draw[drive] (3.7,0.15) -- (4.8,1.30);
\node[lbl] at (5.65,0.95) {intended};

% Leakage path
\draw[drive,dashed] (3.7,1.65) -- (4.9,2.5);
...
% TODO: Rendere più chiaro il disegno
...
% TODO: Write the complete derivation of this expression
However it is possible to derive analitically a leakage bound through the utilization of the time-dependent Schrieffer--Wolff framework, where the accumulated coherent leakage is controlled not only by the size of the block-off-diagonal Hamiltonian but also by the rate at which it varies in time. In schematic form, their bound reads
\begin{equation}
L_{\mathrm{tot}}
\lesssim
...
% TODO: Recheck if I want this in my thesis since
...
% TODO: Deciding if I want to keep this stuff in, since crab and krotov are not the main focus of my thesis
