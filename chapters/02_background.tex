...
\begin{tikzpicture}[
    ...
    act/.style={rectangle, draw, rounded corners, minimum width=7mm, minimum height=6mm},
    arrow/.style={-{Latex[length=1.8mm]}, thick}
]
% Inputs
\node[neuron] (x1) at (0,1.2) {$x_1$};
\node[neuron] (x2) at (0,0.0) {$x_2$};
\node[neuron] (x3) at (0,-1.2) {$x_3$};

% Sum and activation
\node[sum] (sum) at (1.8,0.0) {$\Sigma$};
\node[act] (phi) at (3.8,0.0) {$\phi$};
\node[neuron] (y) at (5.6,0.0) {$y$};
...
% Bias
\draw[arrow] (1.8,-1.0) -- node[right, pos=0.2] {\scriptsize $b$} (sum);
\end{tikzpicture}
...
\begin{tikzpicture}[
    x=0.9cm,y=0.9cm,
    neuron/.style={circle, draw, minimum size=5mm, inner sep=0pt},
...
% Input layer
\node[neuron] (i1) at (\xone,1.8) {};
\node[neuron] (i2) at (\xone,0.6) {};
\node[neuron] (i3) at (\xone,-0.6) {};
\node[neuron] (i4) at (\xone,-1.8) {};

% Hidden layer 1
\node[neuron] (h11) at (\xtwo,2.4) {};
\node[neuron] (h12) at (\xtwo,0.8) {};
\node[neuron] (h13) at (\xtwo,-0.8) {};
\node[neuron] (h14) at (\xtwo,-2.4) {};

% Hidden layer 2
\node[neuron] (h21) at (\xthree,1.6) {};
\node[neuron] (h22) at (\xthree,0.0) {};
\node[neuron] (h23) at (\xthree,-1.6) {};

% Output layer
\node[neuron] (o1) at (\xfour,0.8) {};
\node[neuron] (o2) at (\xfour,-0.8) {};
...
% Labels
\node at (\xone,-2.8) {\small input layer};
\node at (\xtwo,-3.2) {\small hidden layer 1};
\node at (\xthree,-2.8) {\small hidden layer 2};
\node at (\xfour,-1.8) {\small output layer};

\node at (\xone,2.6) {\small $\bm{x}$};
\node at (\xfour,1.6) {\small $f_\theta(\bm{x})$};
\end{tikzpicture}
