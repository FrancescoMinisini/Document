\section{Derivation of the TSWT-based coherent leakage bound}
...
\subsection{Hamiltonian decomposition and perturbative regime}
...
\subsection{Time-dependent Schrieffer--Wolff transformation}
...
\subsection{Perturbative construction of the generator}
...
\subsection{Interaction-picture expression for the leakage amplitude}
...
\subsection{Repeated integration by parts and the coherent leakage bound}
...
\subsection{Interpretation of the different terms}
...
\section{Derivation of the effective three-level rotating-frame Hamiltonian}
...
\subsection{Three-level truncation of a driven weakly anharmonic mode}
...
\subsection{Transformation to the rotating frame}
...
\subsection{Resonant drive and rotating-wave approximation}
