...
\While{the stopping condition is not satisfied}
    ...
    \State determine whether the episode terminates because of:
    \begin{itemize}
        \item maximum allowed runtime,
        \item or sufficiently low cost (optionally with a minimum fidelity constraint)
    \end{itemize}
