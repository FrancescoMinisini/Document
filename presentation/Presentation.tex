...
\begin{columns}
    ...
    \small
            \begin{itemize}
                \item For scalable and reliable quantum devices, high-fidelity, fast, and robust quantum gates are needed, their computational unit. 
...
A solution to the control problem is a sequence of control vectors \[\{u(t)\}_{t=0}^T\] .
    ...
    Therefore \(u(t)\) is the \textbf{full control authority} of the agent, being the only media through which the agent interacts with the environment. 
