...
%     \column{0.48\textwidth}
    ...
    No public implementation was available, the whole framework had to be rebuilt from scratch. This included:
        \begin{itemize}
        % \item reconstructed the full framework from the paper
        \item Quantum Environment two-qubit gmon architecture simulator 
